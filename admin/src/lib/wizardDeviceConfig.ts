export const wizardDeviceConfig = {
	...
	awayButton: {
		i18n: 'wizard-awayButton',
		tooltip: 'wizard-awaybutton-tooltip',
		fields: [
			{
				name: 'name',
				i18n: 'wizard-deviceName',
				type: 'input',
				tooltip: 'wizard-awaybutton-name-tooltip',
			},
			{
				name: 'selectID-awaybutton',
				type: 'selectID',
				multiple: false,
				i18n: 'wizard-button-awaybutton',
				tooltip: 'wizard-button-awaybutton-tooltip',
				objName: 'button_0',
			},
		],
		dsConfigTemplate: {
	...
	doorbell: {
		i18n: 'wizard-doorbell',
		tooltip: 'wizard-doorbell-tooltip',
		fields: [
			{
				name: 'name',
				i18n: 'wizard-deviceName',
				type: 'input',
				tooltip: 'wizard-doorbell-name-tooltip',
			},
			{
				name: 'selectID-doorbell',
				type: 'selectID',
				multiple: false,
				i18n: 'wizard-button-doorbell',
				tooltip: 'wizard-button-doorbell-tooltip',
				objName: 'button_0',
			},
		],
		dsConfigTemplate: {
